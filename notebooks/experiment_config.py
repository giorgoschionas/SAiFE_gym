...
DRIFT = [0]
VOLATILITY = [0.015]#[0.005, 0.01, 0.015, 0.02, 0.025, 0.03]
FEE_TIER = [0.003]
EXP_VALUE = [1.0001]
...
# Number of passes over the training-trajectory batch. Sets the SB3 training
# budget: SB3_TOTAL_TIMESTEPS = TRAIN_EPOCHS * NUM_TRAJECTORIES_TRAIN
#                              * N_STEPS // DECISION_STRIDE
TRAIN_EPOCHS = [4]
