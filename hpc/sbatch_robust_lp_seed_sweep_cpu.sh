...
TOTAL_TIMESTEPS=${TOTAL_TIMESTEPS:-5500000}
...
PERIODIC_REBALANCE_EVERY=${PERIODIC_REBALANCE_EVERY:-20}
PERIODIC_WIDTH=${PERIODIC_WIDTH:-250}
...
NOMINAL_ARRIVAL_RATE=${NOMINAL_ARRIVAL_RATE:-250.0}
